 ...
 * Build initial pages.
 */
add_action( 'after_switch_theme', 'ucsc_create_page_on_theme_activation' );

function ucsc_create_page_on_theme_activation(){

    // Set the title, template, etc
    $new_page_title     = __('About Theme','theme-ucsc'); // Page's title
    $new_page_content   = 'New Them Stuff';                           // Content goes here
    $new_page_template  = 'page.php';       // The template to use for the page
