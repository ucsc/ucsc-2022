...
if ( ! function_exists( 'ucsc_setup' ) ) :
	...
	function ucsc_setup() {
		...
		*/
		$styled_blocks = array( 'button', 'post-template', 'post-author', 'site-title', 'query-pagination', 'post-content', 'rss', 'post-title', 'post-comments', 'navigation', 'list', 'separator', 'latest-posts');
